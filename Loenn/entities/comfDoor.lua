...
local theAlmightyMightyComfDoorOfDeathAndSuffering = {}

theAlmightyMightyComfDoorOfDeathAndSuffering.name = "DoonvHelper/ComfDoor"
theAlmightyMightyComfDoorOfDeathAndSuffering.depth = 0
theAlmightyMightyComfDoorOfDeathAndSuffering.nodeLimits = {0, 1}
theAlmightyMightyComfDoorOfDeathAndSuffering.minimumSize = {40, 8}
theAlmightyMightyComfDoorOfDeathAndSuffering.fieldInformation = {
    requires = {
        fieldType = "integer",
    }
}
theAlmightyMightyComfDoorOfDeathAndSuffering.placements = {
    name = "normal",
    data = {
        width = 40,
        requires = 0,
...
local wallColor = {0.580, 0.424, 0.765}
local heartPadding = 4
local edgeTexture = "objects/DoonvHelper/comfDoor/edge"
local heartTexture = "objects/DoonvHelper/comfDoor/icon00"
...
function theAlmightyMightyComfDoorOfDeathAndSuffering.sprite(room, entity)
...
function theAlmightyMightyComfDoorOfDeathAndSuffering.drawSelected(room, layer, entity, color)
...
function theAlmightyMightyComfDoorOfDeathAndSuffering.selection(room, entity)
    local nodes = entity.nodes
    local x, y = entity.x or 0, entity.y or 0
    local width = entity.width or 40
    local roomWidth, roomHeight = room.width, room.height
...
return theAlmightyMightyComfDoorOfDeathAndSuffering